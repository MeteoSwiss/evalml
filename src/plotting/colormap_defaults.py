...
_CMAP_DEFAULTS = {
    ...
    "TOT_PREC_1H": {
        ...
        "vmax": 160,
        "units": "mm",
        "levels": [0, 0.10, 0.16, 0.25, 0.40, 0.63, 1.00, 1.60, 2.50, 4.00, 6.30, 10.00, 16.00, 25.00, 40.00, 63.00, 100.00, 160.00],
    },
    "TOT_PREC_6H": {
        "colors": [
            "#ffffff",
        ...
        "vmax": 120,
        "units": "mm",
        "levels": [0, 0.5, 1.0, 2.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 40.0, 50.0, 60.0, 70.0, 80.0, 100.0, 120.0],
    },
}
