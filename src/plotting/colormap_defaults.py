...
_CMAP_DEFAULTS = {
    ...
    "T_2M.RMSE.spatial":     {"cmap": plt.get_cmap("Reds", 6), "levels": np.arange(start = 0, stop = 6.1, step = 1)} | {"units": "°C"},
    ...
    "T_2M.MAE.spatial":     {"cmap": plt.get_cmap("Reds", 6), "levels": np.arange(start = 0, stop = 6.1, step = 1)} | {"units": "°C"},
    ...
    "T_2M.BIAS.spatial":     {"cmap": plt.get_cmap("RdBu_r", 11), "levels" : np.arange(start = -5.5, stop = 5.6, step = 1)} | {"units": "°C"},
